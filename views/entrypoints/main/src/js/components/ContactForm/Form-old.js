...
const Form = (props) => {
  ...
  return (
    <Popup handleClose={props.closeForm}>
      <div className="form-container">
        <form onSubmit={props.handlerSaveForm}>
          <Header title={props.title} handlerCloseBtn={props.closeForm} />
          <div className="form-body">
            <Avt color={props.contact.color} changeColor={props.changeColor} firstLetter={firstLetter} />
          ...
          <div className="form-footer">
            <input type="reset" value="Reset" className="form__btn form__btn--reset" onClick={props.resetForm} />
