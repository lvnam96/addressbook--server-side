...
const ContactItem = (props) => (
  <div
    ...
    <div className="contact-item__btns-container">
      <div className="contact-item__btn" onClick={props.handlerClickEditBtn} title="Edit this contact">
        <i className="fas fa-pen" />
      </div>
      <div className="contact-item__btn" onClick={props.handlerClickRemoveBtn} title="Delete this contact">
