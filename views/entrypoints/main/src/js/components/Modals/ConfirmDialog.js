        ...
        <div className="row align-items-center justify-content-between">
          <div className="col-auto">
            <p className="text-right">
              <a href="#" className="rounded-sm confirm-dialog__btn confirm-dialog__btn--yes" onClick={allowToDoAction}>
                {props.labelYES}
              </a>
            </p>
          </div>
          <div className="col-auto">
            <p className="text-right">
              <a href="#" className="rounded-sm confirm-dialog__btn confirm-dialog__btn--no" onClick={cancelAction}>
                {props.labelNO}
              </a>
            </p>
          </div>
