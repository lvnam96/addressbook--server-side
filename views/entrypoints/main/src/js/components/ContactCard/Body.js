  ...
  <div className="contact-card__body">
    ...
    <div className="contact-card__details-container">
      {props.contact.phone && (
        <DetailsRow
          child={
            <a href={'tel:+84' + props.contact.phone} rel="nofollow">
              +84{props.contact.phone}
            </a>
          }
      ...
      {props.contact.birth && (
        <DetailsRow child={displayBirthday(props.contact.birth)} iconClass="fas fa-birthday-cake" />
      )}
      ...
      {props.contact.relationship && <DetailsRow child={props.contact.relationship} iconClass="fas fa-user-friends" />}
    </div>
  </div>
);
