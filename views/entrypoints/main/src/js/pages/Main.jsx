...
import { preventBodyElemScrolling, setBodyElemScrollable } from '../helpers/DOMHelper';
...
class MainPage extends React.Component {
  constructor (props) {
    ...
    this.handlePressEscapeBtn = this.handlePressEscapeBtn.bind(this);
  }
  ...
  componentDidMount () {
    ...
    document.addEventListener('keyup', this.handlePressEscapeBtn);
  }

  componentWillUnmount () {
    document.removeEventListener('keyup', this.handlePressEscapeBtn);
  }

  handlePressEscapeBtn (e = window.event) {
  ...
  openConfirmDialog (content, cb) {
    if (!cb) {
      throw new Error('Callback is not provided! Check openConfirmDialog method in ./pages/Main.js');
    }
