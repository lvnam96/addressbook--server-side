        ...
        <form action="/signin" method="post" className="signin-form" onSubmit={props.onSubmit}>
            ...
            {props.isSignedUp ? (
                ...
                <div>
                    <div
                        className={
                            'border border-success text-success px-2 py-2 mb-3' +
                            (props.isUnameUsed === false ? '' : ' d-none')
                        }>
                    ...
                    <div
                        className={
                            ...
                            (props.isSigningUpFailed ? '' : ' d-none')
                        }>
                    ...
                    <div
                        className={
                            'border border-warning text-warning px-2 py-2 mb-3' +
                            (props.isPasswdMatched === false ? '' : ' d-none')
                        }>
                    ...
                    <div
                        className={
                            'border border-success text-success px-2 py-2 mb-3' +
                            (props.isPasswdMatched === true ? '' : ' d-none')
                        }>
                ...
                <div className="row align-items-center">
                    <div className="col-12 px-0 text-right">
                        <button
                            ...
                            type="submit"
                            disabled={
                                !props.isReadyToSubmit || props.isSubmitting || props.isSignedUp ? 'disabled' : ''
                            }>
