    ...
    return (
        <nav className='sticky-nav'>
            ...
            <nav className='main-nav'>
                ...
                <NavBtn isDropdownBtn={true} inputId="sort-toggle" title='Display contacts whose birthday is in current week/month' label="Filter by births in..." icon="fa-birthday-cake" onClick={props.openFilterSubNav} />
                ...
                <NavBtn isDropdownBtn={true} inputId="bckp-rstr-toggle" label="Backup / Restore" icon="fa-floppy-o" onClick={props.openBackupRestoreSubNav} />
                <NavBtn moreClass="backup-btn" label="Backup" icon="fa-download" onClick={props.handlerBackupData} />
                <NavBtn moreClass="restore-btn" label="Restore" icon="fa-upload" onClick={props.handlerRestoreData} />
                <NavBtn label="Add new contact" icon="fa-plus" onClick={props.handlerAddNewContact} />
            </nav>
        </nav>
    );
};
